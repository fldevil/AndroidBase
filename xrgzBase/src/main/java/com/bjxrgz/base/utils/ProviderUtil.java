...
public class ProviderUtil {
     ...
     * @return 查询到的数据
     */
    public static List<Map<String, String>> getProviderColumn(Context context, Uri uri, String[] projection,
                                                              String selection,
    ...
    public static String getProviderColumnTop(Context context, Uri uri, String[] projection, String selection,
    ...
    public static List<Map<String, String>> getImage(Context context) {
        ...
        return getProviderColumn(context, uri, projection, null, null, orderBy);
    }
