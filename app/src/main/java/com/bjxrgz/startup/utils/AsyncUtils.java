...
public class AsyncUtils {
    ...
    public static final ExecutorService threadPool = Executors.newCachedThreadPool(); // 线程池

    public static final Handler mainHandler = new Handler(Looper.getMainLooper()); // 主线程handler
     ...
     */
    public AsyncUtils(Type type, int corePoolSize) {
        // 构造有定时功能的线程池
